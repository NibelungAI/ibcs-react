...
/**
 * Demo dashboard. A control bar drives every view: the theme preset and the
...
export function App() {
  ...
  return (
    <div
      style={{ maxWidth: 1200, margin: "0 auto", padding: "32px 24px 64px", overflowX: "hidden" }}
    >
      <header style={{ marginBottom: 18 }}>
        <div
          style={{ fontSize: 12, letterSpacing: 1.5, textTransform: "uppercase", color: "#9a9992" }}
        >
          ibcs-react
        </div>
      ...
      <RevenueCard data={data.quarter} comparison={comparison} replay={replay} tokens={tokens} />
    ...
    <Section
      ...
      action={
        <span style={{ display: "inline-flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
          ...
          <MarkToggle mark={mark} onChange={setMark} />
        </span>
      }
    >
      <StatementTable
    ...
    <section style={cardStyle}>
      ...
      >
        <div>
          ...
          <p style={{ fontSize: 12.5, color: "#6b6a64", margin: "0 0 14px", maxWidth: 560 }}>
            {subtitle}
          </p>
        </div>
        {action}
