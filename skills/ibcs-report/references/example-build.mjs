...
import { R, TOKENS, FMT, makePage, coverBody, contents, notationKey,
         lockup, css, documentHtml, scaleUnits, H2, P, CAP } from "./kit.mjs";
import fs from "node:fs";

const h = React.createElement;
const INK = "#171B1F";
const TOTAL = 6;
const page = makePage({ entity: "Vantera Industrial Group AG", total: TOTAL,
...
const pnl = scaleUnits([
  { id: "revenue", label: "Revenue", flow: "add",
    values: { AC: 412300, PY: 373500, PL: 410500 },
    children: [
      { id: "drive", label: "Drive Systems", flow: "add", values: { AC: 214800, PY: 198400, PL: 220000 } },
      { id: "thermal", label: "Thermal Solutions", flow: "add", values: { AC: 121600, PY: 108900, PL: 118500 } },
      { id: "services", label: "Industrial Services", flow: "add", values: { AC: 75900, PY: 66200, PL: 72000 } },
    ] },
  { id: "cogs", label: "Cost of goods sold", flow: "subtract", higherIsBetter: false,
    values: { AC: 267100, PY: 237700, PL: 258600 },
    children: [
      { id: "materials", label: "Raw materials and consumables", flow: "subtract", higherIsBetter: false, values: { AC: 168900, PY: 146700, PL: 161900 } },
      { id: "labour", label: "Direct labour", flow: "subtract", higherIsBetter: false, values: { AC: 63400, PY: 58900, PL: 62700 } },
      { id: "overhead", label: "Manufacturing overhead", flow: "subtract", higherIsBetter: false, values: { AC: 34800, PY: 32100, PL: 34000 } },
    ] },
  { id: "gp", label: "Gross profit", flow: "result", values: { AC: 145200, PY: 135800, PL: 151900 } },
  { id: "rd", label: "Research and development", flow: "subtract", higherIsBetter: false, values: { AC: 24600, PY: 21800, PL: 24000 } },
  { id: "sd", label: "Selling and distribution", flow: "subtract", higherIsBetter: false, values: { AC: 41200, PY: 38900, PL: 41800 } },
  { id: "admin", label: "Administrative expenses", flow: "subtract", higherIsBetter: false, values: { AC: 19400, PY: 18600, PL: 20100 } },
  { id: "ooi", label: "Other operating income", flow: "add", values: { AC: 6200, PY: 5400, PL: 5000 } },
  { id: "ooe", label: "Other operating expenses", flow: "subtract", higherIsBetter: false, values: { AC: 5900, PY: 4100, PL: 4500 } },
  ...
  { id: "finres", label: "Financial result, net", flow: "subtract", higherIsBetter: false, values: { AC: 5700, PY: 4500, PL: 5400 } },
  { id: "pbt", label: "Profit before tax", flow: "result", values: { AC: 54600, PY: 53300, PL: 61100 } },
  { id: "tax", label: "Income tax expense", flow: "subtract", higherIsBetter: false, values: { AC: 13900, PY: 13600, PL: 15600 } },
  { id: "profit", label: "Profit for the period", flow: "result", values: { AC: 40700, PY: 39700, PL: 45500 } },
]);
...
const bs = scaleUnits([
  { id: "nca", label: "Non-current assets", flow: "add", emphasis: true,
    values: { AC: 211300, PY: 202100 },
    children: [
      { id: "intangibles", label: "Intangible assets and goodwill", flow: "add", values: { AC: 48600, PY: 46900 } },
      { id: "ppe", label: "Property, plant and equipment", flow: "add", values: { AC: 132400, PY: 124800 } },
      { id: "rou", label: "Right-of-use assets", flow: "add", values: { AC: 18900, PY: 19700 } },
      { id: "onca", label: "Deferred tax and other", flow: "add", values: { AC: 11400, PY: 10700 } },
    ] },
  { id: "ca", label: "Current assets", flow: "add", emphasis: true,
    values: { AC: 224700, PY: 200900 },
    children: [
      { id: "inventories", label: "Inventories", flow: "add", values: { AC: 96700, PY: 78400 } },
      { id: "receivables", label: "Trade receivables", flow: "add", values: { AC: 71800, PY: 61300 } },
      { id: "occa", label: "Contract and other current assets", flow: "add", values: { AC: 22000, PY: 19600 } },
      { id: "cash", label: "Cash and cash equivalents", flow: "add", values: { AC: 34200, PY: 41600 } },
    ] },
  { id: "ta", label: "Total assets", flow: "result", values: { AC: 436000, PY: 403000 } },
  { id: "equity", label: "Total equity", flow: "add", emphasis: true, values: { AC: 205200, PY: 181200 } },
  { id: "ncl", label: "Non-current liabilities", flow: "add", emphasis: true, higherIsBetter: false,
    values: { AC: 136600, PY: 131100 },
    children: [
      { id: "debt-nc", label: "Financial debt", flow: "add", higherIsBetter: false, values: { AC: 88400, PY: 84300 } },
      { id: "lease-nc", label: "Lease liabilities", flow: "add", higherIsBetter: false, values: { AC: 14200, PY: 15100 } },
      { id: "provisions", label: "Pensions, deferred tax, provisions", flow: "add", higherIsBetter: false, values: { AC: 34000, PY: 31700 } },
    ] },
  { id: "cl", label: "Current liabilities", flow: "add", emphasis: true, higherIsBetter: false,
    values: { AC: 94200, PY: 90700 },
    children: [
      { id: "debt-c", label: "Financial debt", flow: "add", higherIsBetter: false, values: { AC: 21500, PY: 24800 } },
      { id: "payables", label: "Trade payables", flow: "add", higherIsBetter: false, values: { AC: 42600, PY: 40300 } },
      { id: "ocl", label: "Contract, lease and other", flow: "add", higherIsBetter: false, values: { AC: 30100, PY: 25600 } },
    ] },
  { id: "tel", label: "Total equity and liabilities", flow: "result", values: { AC: 436000, PY: 403000 } },
]);
...
const keyRows = scaleUnits([
  ...
  { id: "profit", label: "Profit for the period", values: { eur: { AC: 40700, PY: 39700, PL: 45500 } } },
]);
const keyCols = [
  { key: "ac", label: "AC 2025", kind: "value", measure: "eur", scenario: "AC" },
  { key: "py", label: "PY 2024", kind: "value", measure: "eur", scenario: "PY" },
  { key: "dpy", label: "ΔPY", kind: "variance", measure: "eur", base: "PY", mode: "abs", mark: "bar" },
  { key: "dpyp", label: "ΔPY %", kind: "variance", measure: "eur", base: "PY", mode: "pct", mark: "pin" },
  { key: "pl", label: "PL 2025", kind: "value", measure: "eur", scenario: "PL", group: "Budget" },
  { key: "dpl", label: "ΔPL", kind: "variance", measure: "eur", base: "PL", mode: "abs", mark: "bar", group: "Budget" },
];

/* ---------------------------------------------------------------- pages */

const p1 = page(coverBody({
  lockupHtml: lockup({ name: "VANTERA", sub: "Industrial Group", scale: 1.25, light: true, ink: INK }),
...
const p3 = page(`${H2("Financial highlights", "2025 actual against prior year and budget · amounts in euro")}
  <div class="table-wrap z90">${R(h(DataTable, {
    columns: keyCols, rows: keyRows, tokens: TOKENS, format: FMT,
    animate: false, tooltip: false,
...
const p4 = page(`${H2("Results of operations", "Consolidated income statement 2025 · amounts in euro")}
...
const p5 = page(`${H2("Earnings bridge", "EBIT, prior year to actual · amounts in euro · each step against budget")}
  <div class="chart">${R(h(WaterfallChart, {
    data: bridgeAC, comparisonData: bridgePL, width: 642, height: 330,
    tokens: TOKENS, format: FMT, animate: false, tooltip: false,
  }))}</div>
...
const p6 = page(`${H2("Financial position", "Statement of financial position at 31 December 2025 · amounts in euro")}
  <div class="table-wrap z92">${R(h(StatementTable, {
    lines: bs, mode: "stock", tokens: TOKENS, format: FMT, animate: false, tooltip: false,
    waterfallWidth: 250, labelMaxWidth: 220,
...
fs.writeFileSync("report.html", documentHtml({
  ...
  css: css({ ink: INK }), pages: [p1, p2, p3, p4, p5, p6],
}));
