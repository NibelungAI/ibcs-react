...
- Agent skills (installable via \`npx skills add NibelungAI/ibcs-react\`), each also served
  raw from this site:
  - [ibcs-report](${SITE_URL}/skills/ibcs-report/SKILL.md): financial statements → print-ready
